...
/* ============================================================
   ...
   ============================================================ */
let NT_ALL = [], NT_FILT = [], NT_SHOWN = 0, NT_CONT = {}, NT_ALCANCE = 0, NT_PUSHTIT = '', NT_FBLISTO = true;
const NT_BATCH = 40;
...
function ntResumenHtml() {
  ...
  return `<div class="nt-resumen">
    ...
    ${NT_FBLISTO ? '' : `<div class="nt-warn">${I.bell} <b>Falta configurar Firebase.</b> Pega el JSON de la cuenta de servicio en Propiedades del script (clave <code>FCM_SERVICE_ACCOUNT</code>) para poder enviar el push. Las noticias sí se guardan y se ven en la app pública.</div>`}
  </div>`;
}
...
async function viewNotificaciones(user) {
  ...
  try {
    ...
    NT_FBLISTO = r.firebaseListo !== false;
