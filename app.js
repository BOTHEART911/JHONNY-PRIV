...
/* AJUSTE 17/07/2026 · LAS 5 APPS EN UN SOLO BLOQUE.
...
function cfRender() {
  ...
  ({
    ...
    plantillas: cfPintaPlantillas, usuarios: cfPintaUsuarios, avanzado: cfPintaAvanzado
  })[CF.tab]();
}
...
function cfAppsCard() {
  ...
  return cfCard('Enlaces de las apps', 'Las 5 apps del proyecto. El botón Copiar arma el mensaje de abajo con el nombre y el enlace de esa app.',
