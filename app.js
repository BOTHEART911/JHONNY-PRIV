...
function cfAppsCard() {
  ...
  return cfCard('Enlaces de las apps', 'Las 6 apps del proyecto. El botón Enviar abre WhatsApp con el mensaje de abajo (nombre y enlace de esa app) para que elijas a quién mandarlo.',
    `<div class="cfg-grid">${filas}
       ${cfArea('cf-k-' + CF_COMPARTIR_KEY, 'Plantilla rápida · Compartir App', cfg[CF_COMPARTIR_KEY],
          'Variables: {nombreApp} y {enlaceApp}. Es lo que se envía con cada botón Enviar.', 4)}
     </div>
     `);
}
