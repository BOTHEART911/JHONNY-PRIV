/* Service Worker — Jhonny Perdomo App Privada
...
/* FASE 0 · el nombre de la caché lleva el prefijo de campaña (storage-ns.js).
   Si storage-ns.js no carga, cae al prefijo 'jp' de la campaña original. */
try { importScripts('./storage-ns.js'); } catch (e) {}
const NS_SW = (self.STORAGE_NS || 'jp');
const CACHE_PREFIJO = NS_SW + '-priv-';
...
self.addEventListener('fetch', (e) => {
  ...
  if (/script\.google\.com|qrserver\.com|googleapis\.com|cloudinary\.com|firebase|gstatic\.com|tile\.openstreetmap\.org|nominatim\.openstreetmap\.org|google\.com\/maps/.test(req.url)) return;
